...
static void setupMultipoleWaterDimer(System& system, pGM_MultipoleForce* pGM_MultipoleForce, pGM_MultipoleForce::NonbondedMethod nonbondedMethod,
                                  pGM_MultipoleForce::PolarizationType polarizationType,
    ...
    pGM_MultipoleForce->setNonbondedMethod(nonbondedMethod);
    pGM_MultipoleForce->setPolarizationType(polarizationType);
    pGM_MultipoleForce->setCutoffDistance(cutoff);
    pGM_MultipoleForce->setMutualInducedTargetEpsilon(1.0e-06);
    pGM_MultipoleForce->setMutualInducedMaxIterations(500);
    pGM_MultipoleForce->setAEwald(1.4024714e+01);
    pGM_MultipoleForce->setEwaldErrorTolerance(1.0e-04);

    std::vector<int> pmeGridDimension(3);
    pmeGridDimension[0] = pmeGridDimension[1] = pmeGridDimension[2] = inputPmeGridDimension;
    pGM_MultipoleForce->setPmeGridDimensions(pmeGridDimension);



    // covalent maps, currently, we only use covalent type 0 for 1-2 pGM covalent bond
    // Assume here, we are testing on water dimer, OHH OHH
    // For pGM model, one has to first define the covalent list
    system.addParticle(1.6007000e+01);
    system.addParticle(1.0080000e+00);
    system.addParticle(1.0080000e+00);

    std::vector<double> oxygenMolecularDipole(2);
    oxygenMolecularDipole[0] = -1.94631779E-01;
    oxygenMolecularDipole[1] = -1.94631779E-01;

    std::vector< int > covalentMap;
    covalentMap.resize(0);
    covalentMap.push_back(1);
    covalentMap.push_back(2);
    pGM_MultipoleForce->setCovalentMap(0, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole( -2.04040520E+00, oxygenMolecularDipole,covalentMap,6.05148582E-01, 1.11004396E+00);


// Hydrogens
    std::vector<double> hydrogenMolecularDipole(1);
    hydrogenMolecularDipole[0]     =  -1.94631779E-01;
    covalentMap.resize(0);
    covalentMap.push_back(0);
    pGM_MultipoleForce->setCovalentMap(1, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole(  1.02020260E+00, hydrogenMolecularDipole,covalentMap,5.36229225E-01, 3.27387015E-01);

    covalentMap.resize(0);
    covalentMap.push_back(0);
    pGM_MultipoleForce->setCovalentMap(2, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole(  1.02020260E+00, hydrogenMolecularDipole,covalentMap,5.36229225E-01, 3.27387015E-01);
    ...
    pGM_MultipoleForce->setCovalentMap(3, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole( -2.04040520E+00, oxygenMolecularDipole,covalentMap,6.05148582E-01, 1.11004396E+00);

    covalentMap.resize(0);
    covalentMap.push_back(3);
    pGM_MultipoleForce->setCovalentMap(4, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole(  1.02020260E+00, hydrogenMolecularDipole,covalentMap,5.36229225E-01, 3.27387015E-01);


    covalentMap.resize(0);
    covalentMap.push_back(3);
    pGM_MultipoleForce->setCovalentMap(5, static_cast<OpenMM::pGM_MultipoleForce::CovalentType>(0), covalentMap);
    pGM_MultipoleForce->addMultipole(  1.02020260E+00, hydrogenMolecularDipole,covalentMap,5.36229225E-01, 3.27387015E-01);


    system.addForce(pGM_MultipoleForce);
}



static void getForcesEnergyMultipoleWaterDimer(Context& context, std::vector<Vec3>& forces, double& energy) {
    std::vector<Vec3> positions(context.getSystem().getNumParticles());

    positions[0]              = Vec3(  1.9427985,  -0.0811842,   0.0291945);
    positions[1]              = Vec3(  2.5748664,   0.0747976,   0.7338702);
    positions[2]              = Vec3(  1.4051092,   0.7335817,  -0.0069494);
    positions[3]              = Vec3( -0.0812987,  -1.9394955,  -0.0291353);
    positions[4]              = Vec3(  0.0750600,  -2.5706888,  -0.7345997);
    positions[5]              = Vec3(  0.7335878,  -1.4017475,   0.0071500);
...
static void testMultipoleWaterDimerMutualPolarization() {

    std::string testName      = "testMultipoleWaterDimerMutualPolarization";
    ...
    System system;
    pGM_MultipoleForce* pGM_MultipoleForce = new pGM_MultipoleForce();;
    setupMultipoleWaterDimer(system, pGM_MultipoleForce, pGM_MultipoleForce::PME, pGM_MultipoleForce::Mutual, 
                                             cutoff, inputPmeGridDimension);
    LangevinIntegrator integrator(0.0, 0.1, 0.01);
    Context context(system, integrator, platform);
    getForcesEnergyMultipoleWaterDimer(context, forces, energy);
...
static void setupAndGetForcesEnergyMultipoleIonsAndWater(AmoebaMultipoleForce::NonbondedMethod nonbondedMethod,
    ...
    LangevinIntegrator integrator(0.0, 0.1, 0.01);
    Context context = Context(system, integrator, platform);
