 ...
 */
// larry: I do not know what is this for?
#ifdef _MSC_VER
    // We don't want to hear about how sprintf is "unsafe".
    #pragma warning(disable:4996)
    // Keep MS VC++ quiet about lack of dll export of private members.
    #pragma warning(disable:4251)
    #if defined(OPENMM_pGM_REFERENCE_BUILDING_SHARED_LIBRARY)
        #define OPENMM_pGM_REFERENCE_EXPORT __declspec(dllexport)
    #elif defined(OPENMM_pGM_REFERENCE_BUILDING_STATIC_LIBRARY) || defined(OPENMM_pGM_REFERENCE_USE_STATIC_LIBRARIES)
        #define OPENMM_pGM_REFERENCE_EXPORT
    #else
        #define OPENMM_pGM_REFERENCE_EXPORT __declspec(dllimport)   // i.e., a client of a shared library
    #endif
#else
    #define OPENMM_pGM_REFERENCE_EXPORT // Linux, Mac
#endif
